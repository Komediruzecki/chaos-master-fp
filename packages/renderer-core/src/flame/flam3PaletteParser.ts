 ...
 *    - User-imported flam3 XML files may use this format
 *
...
import { paletteEntry } from '@/flame/colorMap'
...
/**
 * Parse the extended flam3 XML format with <color> child elements.
 * This format is used by some user-exported flam3 files.
 */
