...
test.describe('Console Error Detection', () => {
  ...
  test('should handle quality preset changes without errors', async ({ page }) => {
    const errors: string[] = []
  ...
  test('should handle timeline interactions without errors', async ({ page }) => {
    const errors: string[] = []
  ...
  test('should handle multiple rapid renders without errors', async ({ page }) => {
    const errors: string[] = []
