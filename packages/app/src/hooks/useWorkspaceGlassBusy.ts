 ...
 * frames.
 *
 * Busy is the canvas being driven: playback, an export, audio modulation, or
 * a gesture - a slider, the camera, a colour or affine drag - holding a history
 * preview open. The canvas converging after an edit is not busy: it would
