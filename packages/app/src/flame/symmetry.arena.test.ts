  ...
  describe('3D fighter', () => {
    it('score sheet, symmetry order, HP and DEF', () => {
      expect(FOLDS.map((n) => sheetRow(FIGHTER_3D, n))).toEqual([
        [1, 900, 1.4, 1.2, 2, 3.5, 2, 160, 38, 39, 0.37, 0.41],
        [2, 930, 2.1, 1.2, 2.5, 2.8, 2, 150, 31, 38, 0.52, 0.3],
        [3, 1060, 2.8, 1.2, 3.8, 2.5, 3, 135, 26, 38, 1.98, 0.25],
        [4, 1206, 3.5, 1.2, 5, 2.3, 4, 130, 26, 39, 0.68, 0.22],
        [5, 1360, 4.2, 1.2, 6.3, 2.2, 5, 130, 30, 39, 3, 0.2],
        [6, 1519, 4.9, 1.2, 7.5, 2.1, 6, 127, 30, 39, 3, 0.18],
        [7, 1680, 5.6, 1.2, 8.8, 2, 7, 127, 34, 39, 3, 0.17],
        [8, 1843, 6.3, 1.2, 10, 1.9, 8, 126, 33, 39, 3, 0.16],
      ])
    })
