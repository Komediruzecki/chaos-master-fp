...
describe('the symmetry order in the grounded stats', () => {
  it('pins it per flame, writer, type and fold count', () => {
    ...
    expect(rows).toEqual([
      ...
      'Spiral Galaxy (3D) rotational 4 by command: order 4, DEF 39, Power 1238',
      ...
      'Spiral Galaxy (3D) rotational 6 by command: order 6, DEF 46, Power 1219',
      ...
      'Spiral Galaxy (3D) dihedral 4 by command: order 5, DEF 42, Power 1226',
      ...
      'Spiral Galaxy (3D) dihedral 6 by command: order 7, DEF 50, Power 1220',
