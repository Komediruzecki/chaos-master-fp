...
import { isSafeFlameEntityId, tryValidateFlame, } from '@/flame/schema/flameSchema'
...
import { AFFINE_3D_KEYS, canAddTransform, isAbsentRef, isAffineLike, isKnownVariationType, normalizeTransformRef, resolveNewTransformId, resolveNewVariationId, resolveTransformKey, resolveVariationType, variationTypeMatchesCurrentFlame, } from './helpers'
import type { FlameDescriptor, TransformFunction, TransformId, } from '@/flame/schema/flameSchema'
