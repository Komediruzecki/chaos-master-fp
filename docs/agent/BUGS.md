...
| 28 | [`ensureCamera` fabricates a camera3D](#ensurecamera-fabricates-a-camera3d-with-fields-that-do-not-exist-in-camera3dobjschema-and-omits-thetaphiradiusroll) | confirmed, low | open | `packages/app/src/components/ArenaOverlay.tsx:45` (`ensureCamera`), `:54` (`position: [0, 0, -5]`), reached from `:735` (`p1PreviewFlame`) |
...
| 55 | [Arena `gameState` written, never read](#reported-low-severity-not-independently-verified) | low, not verified | open | `packages/app/src/components/ArenaOverlay.tsx:485` (`gameState`), `packages/app/src/commands/types.ts:134` (`gameState`) |
