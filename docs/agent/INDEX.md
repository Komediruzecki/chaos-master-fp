...
| ------------------ | ----------------------- | ------------ | ------ |
| `packages/app`     | `chaos-master`          | 1023         | 171.2k |
| `packages/landing` | `@chaos-master/landing` | 19           | 2.5k   |
| `packages/core`    | `@chaos-master/core`    | 17           | 1.8k   |
...
| `Home`                  | [HomeFlame.tsx](../../packages/app/src/components/Home/HomeFlame.tsx)                                          | 4.0k | _(no header comment)_                                                                                                                        |
...
| `WorkspaceSidebar`      | [index.ts](../../packages/app/src/components/WorkspaceSidebar/index.ts)                                        | 2.5k | _(no header comment)_                                                                                                                        |
| `ExportPngDialog`       | [ExportPngDialog.tsx](../../packages/app/src/components/ExportPngDialog/ExportPngDialog.tsx)                   | 2.0k | _(no header comment)_                                                                                                                        |
...
| `LoadFlameModal`        | [LoadFlameModal.tsx](../../packages/app/src/components/LoadFlameModal/LoadFlameModal.tsx)                      | 1.5k | Keep one malformed stored/generated flame from taking down the whole modal.                                                                  |
...
| `TouchSurface`          | [index.ts](../../packages/app/src/components/TouchSurface/index.ts)                                            | 1.3k | _(no header comment)_                                                                                                                        |
...
| `ExportJobs`            | [OffscreenAnimationRender.tsx](../../packages/app/src/components/ExportJobs/OffscreenAnimationRender.tsx)      | 1.1k | A read-only Signal whose getter is reactive — interactive cameras are off, so the setter is never called.                                    |
...
| `HelpModal`             | [HelpModal.tsx](../../packages/app/src/components/HelpModal/HelpModal.tsx)                                     | 650  | _(no header comment)_                                                                                                                        |
...
| `Modal`                 | [Modal.tsx](../../packages/app/src/components/Modal/Modal.tsx)                                                 | 200  | Allows the subtree to request modals in async code for the purpose of user input.                                                            |
...
| `middleware` | [rateLimit.ts](../../packages/app/src/worker/middleware/rateLimit.ts) | 200 | Rate-limit the write endpoints per IP.                                                                                                       |

#### WebMCP (`packages/app/src/webmcp/`) — agent-callable tool surface

| Module  | Entry point                                              | LOC  | What it is                                     |
| ------- | -------------------------------------------------------- | ---- | ---------------------------------------------- |
| `tools` | [index.ts](../../packages/app/src/webmcp/tools/index.ts) | 5.4k | Barrel export for all WebMCP tool definitions. |
...
| [tasteStore.ts](../../packages/app/src/arcade/tasteStore.ts)           | 300 | Persistent taste profile store and flame feature extraction for Evolutionary Art Director.                                                   |
...
| [useWorkspaceTimelineBinding.ts](../../packages/app/src/hooks/useWorkspaceTimelineBinding.ts) | 400 | _(no header comment)_ |
...
| [useWorkspaceAutosave.ts](../../packages/app/src/hooks/useWorkspaceAutosave.ts)               | 150 | _(no header comment)_ |
...
| [timelineActions.ts](../../packages/app/src/recorder/timelineActions.ts)           | 400  | Give a compound timeline edit a stable semantic origin when the supplied timeline is recorder-aware.                                         |
...
| File                                                                                   | LOC | What it is                    |
| -------------------------------------------------------------------------------------- | --- | ----------------------------- |
| [workspaceLayoutStore.ts](../../packages/app/src/stores/workspaceLayoutStore.ts)       | 200 | _(no header comment)_         |
...
| [audioAnalysis.ts](../../packages/app/src/utils/audioAnalysis.ts)           | 900  | Creates a real-time audio analyzer from the microphone.                                                                                      |
| [sonification.ts](../../packages/app/src/utils/sonification.ts)             | 800  | _(no header comment)_                                                                                                                        |
| [flameImport.ts](../../packages/app/src/utils/flameImport.ts)               | 550  | Effectively "all" — every store is capped well below this.                                                                                   |
...
| [animationExport.ts](../../packages/app/src/utils/animationExport.ts)       | 400  | _(no header comment)_                                                                                                                        |
...
| [useAudioReactive.ts](../../packages/app/src/utils/useAudioReactive.ts)     | 300  | Audio-reactive effect hook: plays audio through AudioContext and drives flame renderSettings at 30fps synced to playback time.               |
...
| [recentFlames.ts](../../packages/app/src/utils/recentFlames.ts)             | 250  | Memo for `loadRecentFlames`, keyed on the exact payload it was built from.                                                                   |

#### Library (`packages/app/src/lib/`, 200+ LOC)

| File                                                                      | LOC | What it is                                                      |
| ------------------------------------------------------------------------- | --- | --------------------------------------------------------------- |
| [WheelZoomCamera3D.tsx](../../packages/app/src/lib/WheelZoomCamera3D.tsx) | 600 | Whether a key press is the focused control's, not the camera's. |
...
| File                                                                        | LOC  | What it is                                               |
| --------------------------------------------------------------------------- | ---- | -------------------------------------------------------- |
| [MainWorkspace.tsx](../../packages/app/src/MainWorkspace.tsx)               | 4.1k | _(no header comment)_                                    |
| [App.tsx](../../packages/app/src/App.tsx)                                   | 400  | _(no header comment)_                                    |
...
| [packages/app/src/MainWorkspace.tsx](../../packages/app/src/MainWorkspace.tsx)                                                                               | 4.1k |
...
| [packages/app/src/flame/randomize.ts](../../packages/app/src/flame/randomize.ts)                                                                             | 1.1k |
...
| `pnpm typecheck`        | `pnpm --filter @chaos-master/core typecheck && NODE_OPTIONS="--max-old-space-size=8192" tsc --noEmit --project packages/app/tsconfig.json`                                                                                                                                                           |
...
| `pnpm test:coverage`    | `pnpm --filter chaos-master exec vitest run --coverage --coverage.provider=v8 --coverage.all --coverage.include="src/**/*.{ts,tsx}" --coverage.exclude="src/**/*.{test,spec}.{ts,tsx}" --coverage.reporter=text-summary --coverage.reporter=json-summary --coverage.reportsDirectory=coverage-audit` |
| `pnpm test`             | `pnpm --filter @chaos-master/core test && pnpm --filter chaos-master exec vitest run && pnpm --filter chaos-master test:scripts`                                                                                                                                                                     |
| `pnpm test:ui`          | `pnpm --filter chaos-master exec vitest --ui`                                                                                                                                                                                                                                                        |
| `pnpm test:watch`       | `pnpm --filter chaos-master exec vitest`                                                                                                                                                                                                                                                             |
| `pnpm test:e2e`         | `playwright test`                                                                                                                                                                                                                                                                                    |
| `pnpm test:e2e:ci`      | `playwright test tests/smoke.spec.ts`                                                                                                                                                                                                                                                                |
