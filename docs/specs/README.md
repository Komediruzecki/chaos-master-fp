...
| [recorder-replay-export.ears.md](recorder-replay-export.ears.md)               | `REQ-RR-` |   39 |          2 | The `.steps.json` session lifecycle: what recording captures and refuses, session validation bounds, replay determinism and side-state restore, follow-cam preparation, and the four export paths including motion blur.                                 |
...
| [touch-and-tablet-layout.ears.md](touch-and-tablet-layout.ears.md)             | `REQ-TL-` |   39 |          2 | Phone/tablet/desktop classification and the manual override, which chrome mounts in each band, the breakpoints and which stylesheet owns them, the touch HUD/rail/inspector surfaces, and the horizontal drag helper.                                    |
