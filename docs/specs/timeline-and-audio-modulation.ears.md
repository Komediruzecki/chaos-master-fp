...
- `packages/app/src/flame/Flam3.tsx:551-603` (`deepClone`), `:1235-1242` (`isAutoFpsReady`) — where the timeline overlay is
...
_(`utils/timeline.ts:774-775` (`isDrivingView`); consumed at `Flam3.tsx:562-565` (`isActive`).)_
...
_(`Flam3.tsx:579-602` (`createEffect`) and `:1235-1242` (`isAutoFpsReady`); `utils/timeline.ts:1437-1458` (`advanceFrame`), `:758-762` (`resetFpsMeter`).)_
