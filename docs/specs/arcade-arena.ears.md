...
_(`stats.ts:361-387` (`detectRotationalSymmetryOrder`), `:496-502` (`symTransformCount`))_
...
> schema materialises `visible: true` (`packages/core/src/schema/flameSchema.ts:256`)
